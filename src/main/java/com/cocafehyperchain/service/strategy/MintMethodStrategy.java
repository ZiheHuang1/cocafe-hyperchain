...
public class MintMethodStrategy extends InvokeMethod {
    ...
    public Transaction prepareTx(String contract, Object param) throws RequestException {
        ...
        if (propertyBusiness == null) {
            PropertyBusiness newProperty = new PropertyBusiness(this.providerManager, contract);
            this.propertyBusinessMap.put(contract, newProperty);
            propertyBusiness = newProperty;
          } 
